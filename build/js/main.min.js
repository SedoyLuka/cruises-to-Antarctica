...
var _burger = require("./modules/modals/burger");
// ---------------------------------
...
},{"./modules/form-validate/form":3,"./modules/modals/burger":9,"./utils/ios-vh-fix":12}],2:[function(require,module,exports){
"use strict";
...
var headerNav = header.querySelector(".header__navigation-wrapper");
var headerToggle = headerNav.querySelector(".header__toggle");
var headerLinks = headerNav.querySelectorAll(".header__link");
var focusLock = new _focusLock.FocusLock();
var onClickLink = closeMenu;
function closeMenu() {
  focusLock.unlock();
...
function initBurger() {
  ...
  document.addEventListener("click", function (evt) {
    ...
    var headerIsTarget = target === headerNav || headerNav.contains(target);
    var headerIsOpened = header.classList.contains("header--opened");
...
},{"../../utils/focus-lock":10}],10:[function(require,module,exports){
"use strict";
